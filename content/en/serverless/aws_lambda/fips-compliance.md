...
<div class="alert alert-warning">To meet FedRAMP Moderate and High authorizations, the FIPS-compliant Datadog Lambda extension can be used within your Lambda Functions. While you can use these FIPS-compliant Lambda components with any Datadog site, end-to-end FIPS compliance requires sending data to the US1-FED site (ddog-gov.com).</div>
{{< /site-region >}}
